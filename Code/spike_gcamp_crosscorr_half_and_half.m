 function spike_gcamp_crosscorr_half_and_half
...
if save_results == 1
    ...
    t = strrep(t,' ','_');
    t = strrep(t,'-','_');
    folder = ['C:\Users\Connor\Desktop\157565_9_27_2019_TL2_spike_gcamp_crosscorr_GLM_half_and_half_', t, '\'];
    mkdir(folder);
end
...
% figure(figNo)
% for i = 1:num_cells3
%     plot(time, tetrode_3_spikes(i+1,:)+2*(i-1))
%     hold on
% end
% title('Tetrode 3 Clusters')
...
halfwaypt = round(size(decspikes1,2)/2)
dectim_half1 = dectim(:,[1:halfwaypt]);
dectim_half2 = dectim(:,[halfwaypt+1:end]);
DFF_interp_half1 = DFF_interp(:,[1:halfwaypt]);
DFF_interp_half2 = DFF_interp(:,[halfwaypt+1:end]);
decspikes1_half1 = decspikes1(:,[1:halfwaypt]);
decspikes1_half2 = decspikes1(:,[halfwaypt+1:end]);
decspikes2_half1 = decspikes2(:,[1:halfwaypt]);
decspikes2_half2 = decspikes2(:,[halfwaypt+1:end]);
decspikes3_half1 = decspikes3(:,[1:halfwaypt]);
decspikes3_half2 = decspikes3(:,[halfwaypt+1:end]);
decspikes4_half1 = decspikes4(:,[1:halfwaypt]);
decspikes4_half2 = decspikes4(:,[halfwaypt+1:end]);
...
% figNo = figNo+1;
% figure(figNo)
% plot(dectim,decspikes2(2,:),'r','LineWidth',2)
% hold on
% plot(dectim,DFF_interp(CellNumber2(2),:),'b','LineWidth',2)
% hold on
...
% title('Cross-Correlation of GCaMP and Convolved Spike Data, \rho = 0.475', 'FontSize', 52)
% ax = gca;
% ax.FontSize = 28;
...
%%%%%%
mdl11_half1=fitglm(DFF_interp_half1',decspikes1_half1(1,:),'linear');
LFPlog_pred11_half1 = predict(mdl11_half1,DFF_interp_half1');
LFPlog_pred11_half2 = predict(mdl11_half1,DFF_interp_half2');

[corr,P] = corrcoef(LFPlog_pred11_half1,decspikes1_half1(1,:));
corrvals11_half1 = corr(1,2)

[corr,P] = corrcoef(LFPlog_pred11_half2,decspikes1_half2(1,:));
corrvals11_half2 = corr(1,2)

figNo=figNo+1;
figure(figNo)
plot(dectim_half1,LFPlog_pred11_half1,'LineWidth',2)
hold on
plot(dectim_half1,decspikes1_half1(1,:),'LineWidth',2)
xlabel('Time (sec)', 'FontSize', 38)
ylabel('\DeltaF/F (GCaMP Data) / Arbitrary (Spike Data)', 'FontSize', 38);
title('GLM 1,1 Half1 Results of GCaMP and Convolved Spike Data', 'FontSize', 52)
ax = gca;
ax.FontSize = 28;
legend({'GCaMP Data', 'Spike Data'}, 'FontSize', 28)
xlim([0 max(dectim_half1)])

figNo=figNo+1;
figure(figNo)
plot(dectim_half2,LFPlog_pred11_half2,'LineWidth',2)
hold on
plot(dectim_half2,decspikes1_half2(1,:),'LineWidth',2)
xlabel('Time (sec)', 'FontSize', 38)
ylabel('\DeltaF/F (GCaMP Data) / Arbitrary (Spike Data)', 'FontSize', 38);
title('GLM 1,1 Half2 Results of GCaMP and Convolved Spike Data', 'FontSize', 52)
ax = gca;
ax.FontSize = 28;
legend({'GCaMP Data', 'Spike Data'}, 'FontSize', 28)
xlim([dectim_half2(1) max(dectim_half2)])
%%%%%%

%%%%%%
mdl12_half1=fitglm(DFF_interp_half1',decspikes1_half1(2,:),'linear');
LFPlog_pred12_half1 = predict(mdl12_half1,DFF_interp_half1');
LFPlog_pred12_half2 = predict(mdl12_half1,DFF_interp_half2');

[corr,P] = corrcoef(LFPlog_pred12_half1,decspikes1_half1(2,:));
corrvals12_half1 = corr(1,2)

[corr,P] = corrcoef(LFPlog_pred12_half2,decspikes1_half2(2,:));
corrvals12_half2 = corr(1,2)

figNo=figNo+1;
figure(figNo)
plot(dectim_half1,LFPlog_pred12_half1,'LineWidth',2)
hold on
plot(dectim_half1,decspikes1_half1(2,:),'LineWidth',2)
xlabel('Time (sec)', 'FontSize', 38)
ylabel('\DeltaF/F (GCaMP Data) / Arbitrary (Spike Data)', 'FontSize', 38);
title('GLM 1,2 Half1 Results of GCaMP and Convolved Spike Data', 'FontSize', 52)
ax = gca;
ax.FontSize = 28;
legend({'GCaMP Data', 'Spike Data'}, 'FontSize', 28)
xlim([0 max(dectim_half1)])
...
figNo=figNo+1;
figure(figNo)
plot(dectim_half2,LFPlog_pred12_half2,'LineWidth',2)
hold on
plot(dectim_half2,decspikes1_half2(2,:),'LineWidth',2)
xlabel('Time (sec)', 'FontSize', 38)
ylabel('\DeltaF/F (GCaMP Data) / Arbitrary (Spike Data)', 'FontSize', 38);
title('GLM 1,2 Half2 Results of GCaMP and Convolved Spike Data', 'FontSize', 52)
ax = gca;
ax.FontSize = 28;
legend({'GCaMP Data', 'Spike Data'}, 'FontSize', 28)
xlim([dectim_half2(1) max(dectim_half2)])
...
%%%%%%
mdl21_half1=fitglm(DFF_interp_half1',decspikes2_half1(1,:),'linear');
LFPlog_pred21_half1 = predict(mdl21_half1,DFF_interp_half1');
LFPlog_pred21_half2 = predict(mdl21_half1,DFF_interp_half2');

[corr,P] = corrcoef(LFPlog_pred21_half1,decspikes2_half1(1,:));
corrvals21_half1 = corr(1,2)

[corr,P] = corrcoef(LFPlog_pred21_half2,decspikes2_half2(1,:));
corrvals21_half2 = corr(1,2)

figNo=figNo+1;
figure(figNo)
plot(dectim_half1,LFPlog_pred21_half1,'LineWidth',2)
hold on
plot(dectim_half1,decspikes2_half1(1,:),'LineWidth',2)
xlabel('Time (sec)', 'FontSize', 38)
ylabel('\DeltaF/F (GCaMP Data) / Arbitrary (Spike Data)', 'FontSize', 38);
title('GLM 2,1 Half1 Results of GCaMP and Convolved Spike Data', 'FontSize', 52)
ax = gca;
ax.FontSize = 28;
legend({'GCaMP Data', 'Spike Data'}, 'FontSize', 28)
xlim([0 max(dectim_half1)])
...
figNo=figNo+1;
figure(figNo)
plot(dectim_half2,LFPlog_pred21_half2,'LineWidth',2)
hold on
plot(dectim_half2,decspikes2_half2(1,:),'LineWidth',2)
xlabel('Time (sec)', 'FontSize', 38)
ylabel('\DeltaF/F (GCaMP Data) / Arbitrary (Spike Data)', 'FontSize', 38);
title('GLM 2,1 Half2 Results of GCaMP and Convolved Spike Data', 'FontSize', 52)
ax = gca;
ax.FontSize = 28;
legend({'GCaMP Data', 'Spike Data'}, 'FontSize', 28)
xlim([dectim_half2(1) max(dectim_half2)])
...
%%%%%%
mdl22_half1=fitglm(DFF_interp_half1',decspikes2_half1(2,:),'linear');
LFPlog_pred22_half1 = predict(mdl22_half1,DFF_interp_half1');
LFPlog_pred22_half2 = predict(mdl22_half1,DFF_interp_half2');

[corr,P] = corrcoef(LFPlog_pred22_half1,decspikes2_half1(2,:));
corrvals22_half1 = corr(1,2)

[corr,P] = corrcoef(LFPlog_pred22_half2,decspikes2_half2(2,:));
corrvals22_half2 = corr(1,2)

figNo=figNo+1;
figure(figNo)
plot(dectim_half1,LFPlog_pred22_half1,'LineWidth',2)
hold on
plot(dectim_half1,decspikes2_half1(2,:),'LineWidth',2)
xlabel('Time (sec)', 'FontSize', 38)
ylabel('\DeltaF/F (GCaMP Data) / Arbitrary (Spike Data)', 'FontSize', 38);
title('GLM 2,2 Half 1 Results of GCaMP and Convolved Spike Data, \rho = 0.9094', 'FontSize', 52)
ax = gca;
ax.FontSize = 28;
legend({'GCaMP Data', 'Spike Data'}, 'FontSize', 28)
xlim([0 max(dectim_half1)])
...
figNo=figNo+1;
figure(figNo)
plot(dectim_half2,LFPlog_pred22_half2,'LineWidth',2)
hold on
plot(dectim_half2,decspikes2_half2(2,:),'LineWidth',2)
xlabel('Time (sec)', 'FontSize', 38)
ylabel('\DeltaF/F (GCaMP Data) / Arbitrary (Spike Data)', 'FontSize', 38);
title('GLM 2,2 Half 2 Results of GCaMP and Convolved Spike Data, \rho = 0.1648', 'FontSize', 52)
ax = gca;
ax.FontSize = 28;
legend({'GCaMP Data', 'Spike Data'}, 'FontSize', 28)
xlim([dectim_half2(1) max(dectim_half2)])
...
%%%%%%
mdl31_half1=fitglm(DFF_interp_half1',decspikes3_half1(1,:),'linear');
LFPlog_pred31_half1 = predict(mdl31_half1,DFF_interp_half1');
LFPlog_pred31_half2 = predict(mdl31_half1,DFF_interp_half2');

[corr,P] = corrcoef(LFPlog_pred31_half1,decspikes3_half1(1,:));
corrvals31_half1 = corr(1,2)

[corr,P] = corrcoef(LFPlog_pred31_half2,decspikes3_half2(1,:));
corrvals31_half2 = corr(1,2)

figNo=figNo+1;
figure(figNo)
plot(dectim_half1,LFPlog_pred31_half1,'LineWidth',2)
hold on
plot(dectim_half1,decspikes3_half1(1,:),'LineWidth',2)
xlabel('Time (sec)', 'FontSize', 38)
ylabel('\DeltaF/F (GCaMP Data) / Arbitrary (Spike Data)', 'FontSize', 38);
title('GLM 3,1 Half1 Results of GCaMP and Convolved Spike Data', 'FontSize', 52)
ax = gca;
ax.FontSize = 28;
legend({'GCaMP Data', 'Spike Data'}, 'FontSize', 28)
xlim([0 max(dectim_half1)])
...
figNo=figNo+1;
figure(figNo)
plot(dectim_half2,LFPlog_pred31_half2,'LineWidth',2)
hold on
plot(dectim_half2,decspikes3_half2(1,:),'LineWidth',2)
xlabel('Time (sec)', 'FontSize', 38)
ylabel('\DeltaF/F (GCaMP Data) / Arbitrary (Spike Data)', 'FontSize', 38);
title('GLM 3,1 Half2 Results of GCaMP and Convolved Spike Data', 'FontSize', 52)
ax = gca;
ax.FontSize = 28;
legend({'GCaMP Data', 'Spike Data'}, 'FontSize', 28)
xlim([dectim_half2(1) max(dectim_half2)])
...
%%%%%%
mdl32_half1=fitglm(DFF_interp_half1',decspikes3_half1(2,:),'linear');
LFPlog_pred32_half1 = predict(mdl32_half1,DFF_interp_half1');
LFPlog_pred32_half2 = predict(mdl32_half1,DFF_interp_half2');

[corr,P] = corrcoef(LFPlog_pred32_half1,decspikes3_half1(2,:));
corrvals32_half1 = corr(1,2)

[corr,P] = corrcoef(LFPlog_pred32_half2,decspikes3_half2(2,:));
corrvals32_half2 = corr(1,2)

figNo=figNo+1;
figure(figNo)
plot(dectim_half1,LFPlog_pred32_half1,'LineWidth',2)
hold on
plot(dectim_half1,decspikes3_half1(2,:),'LineWidth',2)
xlabel('Time (sec)', 'FontSize', 38)
ylabel('\DeltaF/F (GCaMP Data) / Arbitrary (Spike Data)', 'FontSize', 38);
title('GLM 3,2 Half1 Results of GCaMP and Convolved Spike Data', 'FontSize', 52)
ax = gca;
ax.FontSize = 28;
legend({'GCaMP Data', 'Spike Data'}, 'FontSize', 28)
xlim([0 max(dectim_half1)])
...
figNo=figNo+1;
figure(figNo)
plot(dectim_half2,LFPlog_pred32_half2,'LineWidth',2)
hold on
plot(dectim_half2,decspikes3_half2(2,:),'LineWidth',2)
xlabel('Time (sec)', 'FontSize', 38)
ylabel('\DeltaF/F (GCaMP Data) / Arbitrary (Spike Data)', 'FontSize', 38);
title('GLM 3,2 Half2 Results of GCaMP and Convolved Spike Data', 'FontSize', 52)
ax = gca;
ax.FontSize = 28;
legend({'GCaMP Data', 'Spike Data'}, 'FontSize', 28)
xlim([dectim_half2(1) max(dectim_half2)])
...
%%%%%%
mdl41_half1=fitglm(DFF_interp_half1',decspikes4_half1(1,:),'linear');
LFPlog_pred41_half1 = predict(mdl41_half1,DFF_interp_half1');
LFPlog_pred41_half2 = predict(mdl41_half1,DFF_interp_half2');

[corr,P] = corrcoef(LFPlog_pred41_half1,decspikes4_half1(1,:));
corrvals41_half1 = corr(1,2)

[corr,P] = corrcoef(LFPlog_pred41_half2,decspikes4_half2(1,:));
corrvals41_half2 = corr(1,2)

figNo=figNo+1;
figure(figNo)
plot(dectim_half1,LFPlog_pred41_half1,'LineWidth',2)
hold on
plot(dectim_half1,decspikes4_half1(1,:),'LineWidth',2)
xlabel('Time (sec)', 'FontSize', 38)
ylabel('\DeltaF/F (GCaMP Data) / Arbitrary (Spike Data)', 'FontSize', 38);
title('GLM 4,1 Half1 Results of GCaMP and Convolved Spike Data', 'FontSize', 52)
ax = gca;
ax.FontSize = 28;
legend({'GCaMP Data', 'Spike Data'}, 'FontSize', 28)
xlim([0 max(dectim_half1)])
...
figNo=figNo+1;
figure(figNo)
plot(dectim_half2,LFPlog_pred41_half2,'LineWidth',2)
hold on
plot(dectim_half2,decspikes4_half2(1,:),'LineWidth',2)
xlabel('Time (sec)', 'FontSize', 38)
ylabel('\DeltaF/F (GCaMP Data) / Arbitrary (Spike Data)', 'FontSize', 38);
title('GLM 4,1 Half2 Results of GCaMP and Convolved Spike Data', 'FontSize', 52)
ax = gca;
ax.FontSize = 28;
legend({'GCaMP Data', 'Spike Data'}, 'FontSize', 28)
xlim([dectim_half2(1) max(dectim_half2)])
...
%%%%%%
mdl42_half1=fitglm(DFF_interp_half1',decspikes4_half1(2,:),'linear');
LFPlog_pred42_half1 = predict(mdl42_half1,DFF_interp_half1');
LFPlog_pred42_half2 = predict(mdl42_half1,DFF_interp_half2');

[corr,P] = corrcoef(LFPlog_pred42_half1,decspikes4_half1(2,:));
corrvals42_half1 = corr(1,2)

[corr,P] = corrcoef(LFPlog_pred42_half2,decspikes4_half2(2,:));
corrvals42_half2 = corr(1,2)

figNo=figNo+1;
figure(figNo)
plot(dectim_half1,LFPlog_pred42_half1,'LineWidth',2)
hold on
plot(dectim_half1,decspikes4_half1(2,:),'LineWidth',2)
xlabel('Time (sec)', 'FontSize', 38)
ylabel('\DeltaF/F (GCaMP Data) / Arbitrary (Spike Data)', 'FontSize', 38);
title('GLM 4,2 Half1 Results of GCaMP and Convolved Spike Data', 'FontSize', 52)
ax = gca;
ax.FontSize = 28;
legend({'GCaMP Data', 'Spike Data'}, 'FontSize', 28)
xlim([0 max(dectim_half1)])
...
figNo=figNo+1;
figure(figNo)
plot(dectim_half2,LFPlog_pred42_half2,'LineWidth',2)
hold on
plot(dectim_half2,decspikes4_half2(2,:),'LineWidth',2)
xlabel('Time (sec)', 'FontSize', 38)
ylabel('\DeltaF/F (GCaMP Data) / Arbitrary (Spike Data)', 'FontSize', 38);
title('GLM 4,2 Half2 Results of GCaMP and Convolved Spike Data', 'FontSize', 52)
ax = gca;
ax.FontSize = 28;
legend({'GCaMP Data', 'Spike Data'}, 'FontSize', 28)
xlim([dectim_half2(1) max(dectim_half2)])
...
% xlabel('Time (sec)', 'FontSize', 38)
% ylabel('\DeltaF/F (GCaMP Data) / Arbitrary (Spike Data)', 'FontSize', 38);
% title('GLM 2,2 Results of GCaMP and Convolved Spike Data', 'FontSize', 52)
% ax = gca;
% ax.FontSize = 28;
% legend({'GCaMP Data', 'Spike Data'}, 'FontSize', 28)
% xlim([0 max(dectim)])
